...
private const val KEY_COMPOSE_DATA_ROW_LOADING_FOOTER = "compose_data_row_loading_footer"

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun <T : DataItem> ComposeDataRow(
    items: List<T>,
    ...
    PullToRefreshBox(
        ...
        LazyRow(
            ...
            if (isLoadingMore) {
                item(key = KEY_COMPOSE_DATA_ROW_LOADING_FOOTER) {
                    Box(
                        modifier = Modifier
                            .fillMaxHeight()
