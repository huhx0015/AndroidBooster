...
interface BaseContract {
    ...
    /**
     * View: Defines the methods that the concrete View aka Fragment will implement. This way you
     * can proceed to create and test the Presenter without worrying about Android-specific
